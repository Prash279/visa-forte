...
export const DOCUMENT_CHECKLIST: Record<string, ChecklistItem[]> = {
  'Pre-Application Eligibility Assessment': [
    ...
    { id: 'language_test', label: 'Language test results (IELTS / CELPIP / TEF)' },
    { id: 'resume', label: 'Updated resume / CV' },
    { id: 'employment_letter', label: 'Employment letter (most recent employer)' },
    { id: 'eca_certificate', label: 'Educational Credential Assessment (ECA) — if applicable' },
  ],
  'PNP Stream Matching': [
    { id: 'passport_bio', label: 'Passport — biographical data page' },
    { id: 'language_test', label: 'Language test results (IELTS / CELPIP / TEF)' },
    ...
    { id: 'noc_confirmation', label: 'NOC code confirmation / job duties description' },
  ...
  'Document Review & Compliance Audit': [
    ...
    { id: 'eca_certificate', label: 'Educational Credential Assessment (ECA)' },
    { id: 'employment_records', label: 'Employment records (letters + pay stubs)' },
  ...
  'ITA Response Preparation': [
    { id: 'passport_all', label: 'Passport — all pages (including blank pages)' },
    { id: 'language_test', label: 'Language test results (all modules)' },
    { id: 'eca_certificate', label: 'Educational Credential Assessment (ECA)' },
    { id: 'degree_transcripts', label: 'Degree certificates and academic transcripts' },
    { id: 'employment_letter', label: 'Employment verification letter (on company letterhead)' },
    { id: 'pay_stubs', label: 'Pay stubs (last 6 months)' },
    { id: 'police_clearance', label: 'Police clearance certificate(s) — all countries lived 6+ months' },
    { id: 'medical_exam', label: 'Medical exam results' },
    { id: 'bank_statements', label: 'Settlement funds — bank statements (last 6 months)' },
  ...
  'Full Application File Management': [
    ...
    { id: 'marriage_certificate', label: 'Marriage certificate (if applicable)' },
    { id: 'birth_certificates', label: 'Birth certificates — dependants (if applicable)' },
    { id: 'photos', label: 'Photos (IRCC-compliant)' },
  ],
  'Post-Submission Monitoring': [
    { id: 'aor_confirmation', label: 'Acknowledgement of Receipt (AOR) confirmation' },
    { id: 'passport_bio', label: 'Passport — biographical data page (current)' },
    { id: 'updated_language_test', label: 'Updated language test (if requested by IRCC)' },
