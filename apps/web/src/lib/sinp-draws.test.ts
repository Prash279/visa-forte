...
describe('analyzeSinpDraws', () => {
  const fiveDates: SinpDraw[] = [
    {
      ...
      cutoffScore: 88,
      invitationsIssued: 57,
    },
    {
      date: '2024-09-12',
      subCategory: 'Occupations In-Demand',
      cutoffScore: 88,
      invitationsIssued: 32,
    },
    {
      date: '2024-06-13',
      subCategory: 'Express Entry',
      cutoffScore: 88,
      invitationsIssued: 88,
    },
    {
      date: '2024-03-07',
      subCategory: 'Express Entry',
      cutoffScore: 89,
      invitationsIssued: 21,
    },
    {
      date: '2023-12-27',
      subCategory: 'Express Entry',
    ...
    },
    {
      ...
      subCategory: 'Express Entry',
      cutoffScore: 84,
      invitationsIssued: 59,
    },
    {
      date: '2023-08-16',
      subCategory: 'Express Entry',
      cutoffScore: 60,
      invitationsIssued: 23,
    },
  ];
  ...
  it('merges sub-categories and sums invitations within a date', () => {
    ...
    expect(top.subCategories).toEqual([
      'Express Entry',
