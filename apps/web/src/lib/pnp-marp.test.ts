...
const profile: ApplicantProfile = {
  ...
  jobDuties: 'Designs and builds machine-learning models; analyses large datasets; writes production Python.',
...
describe('buildPnpMarpMarkdown', () => {
  ...
  it('renders an ambiguity callout only when flagged', () => {
    const flagged = buildPnpMarpMarkdown(profile, assessPnp(profile, { ...noc, ambiguity: { flag: true, alternatives: [{ nocCode: '22220', teer: 2, title: 'X' }] } }))
