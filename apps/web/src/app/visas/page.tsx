...
export const metadata = buildMetadata({
  title:
    'Canadian Immigration Programs — Visa Forte | Express Entry · PNP · Pathways',
  description:
    ...
    <main className="visas-main">
      ...
      <section className="visas-hero">
        <div className="visas-hero-inner">
          ...
          <p className="visas-hero-lead r d2">
            Every pathway below begins with the same two gates: meeting the
            eligibility threshold, then submitting a documentation package that
            survives IRCC scrutiny. The first gate is determined by your
            profile. The second is entirely within your control — if you know
            exactly what IRCC requires, in the format it requires it.
          </p>
          <div className="visas-hero-actions r d3">
            <a href="#express-entry" className="btn-primary">
              Explore Express Entry
            </a>
            <a href="#pnp" className="link-ghost">
            ...
            <div className="sec-inner">
              ...
              <div className="visas-draw-grid">
                <div className="visas-draw-card r d2">
                  <span className="visas-draw-card-label">
                    CRS Cutoff Score
                  </span>
                  <span className="visas-draw-card-value">
                    {draw.cutoffScore}
                  </span>
                  <span className="visas-draw-card-sub">
                    Minimum score to receive an invitation
                  </span>
                </div>
                <div className="visas-draw-card r d3">
                  <span className="visas-draw-card-label">Type of Draw</span>
                  <span className="visas-draw-card-value visas-draw-card-value--text">
                    {draw.type}
                  </span>
                  <span className="visas-draw-card-sub">
                    Program stream targeted this round
                  </span>
                </div>
                <div className="visas-draw-card r d4">
                  ...
                  <span className="visas-draw-card-value">
                    {formatNumber(draw.invitationsIssued)}
                  </span>
                  <span className="visas-draw-card-sub">
                    Total ITAs issued in this draw
                  </span>
                </div>
                <div className="visas-draw-card r d5">
                  <span className="visas-draw-card-label">Date of Draw</span>
                  <span className="visas-draw-card-value visas-draw-card-value--date">
                    {formatDrawDate(draw.date)}
                  </span>
                  <span className="visas-draw-card-sub">
                    Most recent IRCC round
                  </span>
                </div>
              </div>
      ...
      <section className="sec visas-program-section" id="express-entry">
        <div className="sec-inner">
          ...
          <h2 className="headline r d1">
            Canada&apos;s primary managed migration system.
            <br />
            Three streams. One pool.
          </h2>
          <div className="rule r d2" />
          <p className="visas-program-lead r d2">
            Express Entry is not a visa — it is a competitive pool. You submit a
            profile, receive a Comprehensive Ranking System (CRS) score, and
            wait for an Invitation to Apply when your score meets or exceeds the
            cutoff of a draw. Three federal programs feed this pool. Which one
            applies to you depends on where your work experience was earned.
          </p>
          ...
          <div className="visas-streams-grid r d3">
            <div className="visas-stream">
              <div className="visas-stream-header">
                ...
                <h3 className="visas-stream-name">
                  Federal Skilled Worker Program
                </h3>
              </div>
              <p className="visas-stream-who">
              ...
              <div className="visas-stream-reqs">
                ...
                <ul className="visas-stream-list">
                  <li>
                    1 year skilled work experience (TEER 0, 1, 2, or 3) in the
                    past 10 years
                  </li>
              ...
              <p className="visas-stream-note">
                Points factors: age, education, language, work experience,
                Canadian relatives, and adaptability. Arranged employment no
                longer adds CRS points (March 2025 change).
              </p>
            </div>
            ...
            <div className="visas-stream">
              ...
              <div className="visas-stream-reqs">
                ...
                <ul className="visas-stream-list">
                  <li>
                    1 year of skilled Canadian work experience (TEER 0, 1, 2, or
              ...
              <p className="visas-stream-note">
                No job offer required. Category-based draws frequently target
                CEC profiles — Canadian experience is a strong competitive
                advantage in the current draw environment.
              </p>
            </div>
            ...
            <div className="visas-stream">
              ...
              <p className="visas-stream-who">
                For workers in qualifying skilled trade occupations.
              </p>
              <div className="visas-stream-reqs">
                <p className="visas-stream-req-label">Minimum requirements</p>
                <ul className="visas-stream-list">
                  <li>
                    2 years full-time skilled trades work experience in the past
                    5 years
                  </li>
                  <li>
                    Language: CLB 5 (speaking and listening), CLB 4 (reading and
                    writing)
                  </li>
                  <li>
                    Job offer of at least 1 year, OR certificate of
                    qualification from a Canadian province
                  </li>
                  <li>No minimum education requirement</li>
                </ul>
              </div>
              <p className="visas-stream-note">
                Not all trades qualify. Eligible TEER codes are specified in
                IRCC regulations. Confirm your occupation code before investing
                in FSTP-specific documentation.
              </p>
            </div>
          </div>
          ...
          <div className="visas-crs-box r">
            ...
            <div className="visas-crs-grid">
              <div className="visas-crs-factor">
                <span className="visas-crs-factor-name">
                  Core Human Capital
                </span>
                <span className="visas-crs-factor-desc">
              ...
              <div className="visas-crs-factor">
                ...
                <span className="visas-crs-factor-desc">
                  Education, language, and Canadian work experience of
                  accompanying spouse
                </span>
              </div>
              <div className="visas-crs-factor">
                ...
                <span className="visas-crs-factor-desc">
                  Combined education + foreign experience, and language +
              ...
              <div className="visas-crs-factor">
                ...
                <span className="visas-crs-factor-desc">
                  Provincial nomination (+600), sibling in Canada (+15), French
                  language ability (+25–50)
                </span>
              </div>
            </div>
            <p className="visas-crs-note">
              Arranged employment points were removed from CRS scoring in March
              2025. A valid Canadian job offer no longer adds CRS points under
      ...
      <section className="sec visas-process-section">
        <div className="sec-inner">
          ...
          <h2 className="headline r d1">
            Eight stages. The 60-day window at stage seven
            <br />
            admits no extension.
          </h2>
          <div className="rule r d2" />
      ...
      <section className="sec visas-docs-section">
        <div className="sec-inner">
          ...
          <h2 className="headline r d1">
            What IRCC examines — and where packages fail.
          </h2>
          <div className="rule r d2" />
          <p className="visas-docs-lead r d2">
            The categories below cover the standard Express Entry documentation
            package. Every document is reviewed against the regulatory criteria
            current at the time of submission — not when it was originally
            drafted. Documents prepared for last year&apos;s framework may fail
            this year&apos;s review.
          </p>
          ...
          <div className="visas-docs-callout r">
            <p>
              <strong>The most common documentation failure:</strong> Employment
              reference letters drafted against the 2016 NOC duty matrix rather
              than the current TEER framework. IRCC treats misaligned duty
              descriptions as unverifiable work experience — every point
      ...
      <section className="sec visas-fees-section" id="processing-times">
        <div className="sec-inner">
          ...
          <div className="visas-fees-layout r d3">
            <div>
              <p className="visas-fees-sublabel">
                Government Processing Fees (CAD)
              </p>
              ...
              <p className="visas-fees-note">
                The above are government processing fees only. Third-party costs
                — ECA (CAD 200–350), language testing (CAD 270–320), medical
                examination, and police certificates — are separate and vary by
            ...
            <div>
              ...
              <p className="visas-fees-note">
                Times reflect 80% of complete applications and change frequently
                with IRCC volumes. Incomplete packages extend timelines. Verify
                current times at{' '}
      ...
      <section className="sec visas-pnp-section" id="pnp">
        <div className="sec-inner">
          ...
          <h2 className="headline r d1">
            Thirteen provinces. Independent criteria.
            <br />
            One strategic advantage.
          </h2>
          <div className="rule r d2" />
          <p className="visas-pnp-lead r d2">
            Every province and territory (except Quebec and Nunavut) operates
            its own Provincial Nominee Program with streams targeting specific
            skills, occupations, and regional labour needs. A provincial
            nomination adds 600 points to your CRS score — enough to guarantee
          ...
          <div className="visas-pnp-grid r d3">
            <div className="visas-pnp-type">
              ...
              <p className="visas-pnp-type-body">
                Provinces nominate candidates directly from the Express Entry
                pool. If nominated, your CRS score increases by 600 points. An
                ITA follows in the next available draw.
              </p>
            ...
            <div className="visas-pnp-type">
              ...
              <p className="visas-pnp-type-body">
                Applied to directly, outside the Express Entry pool. Processing
                is slower but available to profiles that do not meet Express
                Entry minimums. Nomination leads directly to a federal PR
                application.
              </p>
              <ul className="visas-pnp-list">
          ...
          <div className="visas-pnp-callout r">
            <p>
              PNP stream availability changes frequently. Provinces open, pause,
              and close streams based on provincial labour market conditions. A
              stream accepting applications last quarter may be suspended today.
              Verify current stream status directly with each provincial
              authority before building a PNP-specific documentation strategy.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="sec visas-other-section" id="other-pathways">
        <div className="sec-inner">
          ...
          <h2 className="headline r d1">
            For profiles outside the Express Entry framework.
          </h2>
          <div className="rule r d2" />
          <div className="visas-other-grid r d3">
            <div className="visas-other-card">
              ...
              <p className="visas-other-body">
                For skilled workers and international graduates with a job offer
                from a designated employer in Atlantic Canada — Nova Scotia, New
                Brunswick, Prince Edward Island, or Newfoundland and Labrador.
                The designated employer initiates the nomination.
              </p>
            </div>
            <div className="visas-other-card">
              <p className="visas-other-tag">RNIP · Community-driven</p>
              <h3 className="visas-other-name">
                Rural and Northern Immigration Pilot
              </h3>
              <p className="visas-other-body">
                For workers with a job offer in a participating rural or
                northern community. Each community recommends candidates based
                on local labour needs and sets eligibility criteria beyond the
                federal minimums. Availability varies by community.
              </p>
            </div>
            <div className="visas-other-card">
              ...
              <p className="visas-other-body">
                For entrepreneurs with an innovative business concept and a
                Letter of Support from a designated Canadian venture capital
                fund, angel investor group, or business incubator. Language
                requirement: CLB 5 in all four abilities.
              </p>
            </div>
            <div className="visas-other-card">
              <p className="visas-other-tag">Caregiver pilots</p>
              <h3 className="visas-other-name">
                Home Child Care &amp; Support Workers
              </h3>
              <p className="visas-other-body">
                Two pathways for home child care providers and home support
                workers holding valid Canadian work permits in the relevant
                occupation. CLB 5 language requirement. No job offer required at
                the point of application.
              </p>
            </div>
          </div>
          <p className="visas-other-note r">
            Quebec operates entirely separate immigration programs (QSWP, Quebec
            Experience Program) with its own selection criteria. Visa Forte does
            not practice in the Quebec immigration stream.
          </p>
        </div>
      </section>
        ...
        <div className="sec-inner">
          <div className="visas-disclaimer r">
            ...
            <p>
              ...
              guidance purposes only, based on publicly available Immigration,
              Refugees and Citizenship Canada (IRCC) regulations and policies.
              This does not constitute legal advice, and no consultant-client
              relationship is created by accessing this content. Immigration
              regulations, program requirements, processing times, and CRS
              cutoff scores are subject to frequent change without notice.
              Verify all information at{' '}
              <a
      ...
      <section className="visas-cta-section">
        <div className="visas-cta-inner">
          ...
          <h2 className="visas-cta-headline r d1">
            ...
            <br />
            Documentation determines whether you walk through it.
          </h2>
          <p className="visas-cta-body r d2">
            Meeting the eligibility threshold is step one. What IRCC actually
            evaluates — the employment letters, the financial proofs, the ECA
            alignment — is where 20 years of documentation practice becomes the
            difference between submission and rejection.
          </p>
