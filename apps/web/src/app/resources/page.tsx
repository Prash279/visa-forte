        ...
        <div className="sec-inner">
          ...
          <div className="tools-hero-card r d2">
            <div className="tools-hero-content">
              ...
              <h3 className="tools-hero-title">
                CanVisa Pro Lite — CRS Score Check
              </h3>
              <p className="tools-hero-desc">
                Enter your profile and get your Express Entry CRS score, the top
                2–3 reasons it&apos;s lower than the last draw cutoff, and the
                highest-probability pathway — in under 3 minutes.
              </p>
            </div>
          ...
          <div className="tools-grid r d3">
            ...
            >
              ...
              <p className="tools-card-desc">
                Move one lever — language, education, or Canadian experience —
                and see the exact point gain. Find the fastest path to the
                cutoff.
              </p>
            </a>
            <a
            ...
            >
              ...
              <p className="tools-card-desc">
                Generate a personalised day-by-day document preparation timeline
                from your ITA date.
              </p>
            </a>
            {[
      ...
      <section className="sec resources-premium">
        <div className="sec-inner">
          ...
          <p className="resources-section-sub r d2">
            Detailed formats, worked examples, and annotated walkthroughs built
            for clients who are actively filing.
          </p>
      ...
      <section className="resources-trust">
        <div className="resources-trust-inner">
          ...
          <h2 className="resources-trust-headline r d1">
            Every resource here was built because a client needed it and nothing
            good enough existed.
          </h2>
          ...
          <p className="resources-trust-body r d2">
            ...
            guide reviewed personally before it goes on this page. If it has our
            name on it, it works.
          </p>
