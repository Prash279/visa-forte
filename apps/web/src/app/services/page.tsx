        ...
        <section className="services-hero">
          <div className="services-hero-inner">
            ...
            <p className="services-hero-lead r d2">
              From initial eligibility through post-submission support, every
              engagement is delivered personally — reviewed against the
              regulatory standard that applies today.
            </p>
          </div>
        </section>
            ...
            <div className="services-grid">
              {SERVICES.map(({ n, name, tag, description, delivers }) => (
                <div className="service-card r" key={n}>
                  ...
                  <Link href="/booking" className="service-card-cta">
                    Assess Now →
                  </Link>
                </div>
              ))}
            ...
            <div className="process-steps r d3">
              <div className="process-step">
                ...
                <p className="process-step-body">
                  Submit a brief profile — your program stream, current CRS
                  score, and the primary documentation concern. This takes under
                  five minutes.
                </p>
              </div>
              ...
              <div className="process-step">
                ...
                <p className="process-step-body">
                  Your profile is reviewed manually against current IRCC
                  criteria. A written assessment identifies which service tier
              ...
              <div className="process-step">
                ...
                <p className="process-step-body">
                  Once scope is agreed and the engagement is confirmed, the
                  documentation review begins. Capacity is limited — files are
                  accepted in order of readiness.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="services-cta-section">
          <div className="services-cta-inner">
            ...
            <h2 className="services-cta-headline r d1">
              Capacity is limited to the files that can be reviewed with the
              attention they require.
            </h2>
            <p className="services-cta-body r d2">
              Not every application will be accepted. The triage assessment
              determines fit before any commitment is made — on either side.
            </p>
