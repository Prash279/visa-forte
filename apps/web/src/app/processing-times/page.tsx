    ...
    <main className="pt-page">
      ...
      <section className="pt-hero">
        <div className="pt-hero-inner">
          ...
          <p className="pt-sub">
            How long IRCC is currently taking to process 80% of complete
            applications, pulled directly from the official IRCC website every
            morning.
          </p>
      ...
      <section className="pt-disclaimer-section">
        <div className="pt-disclaimer-inner">
          <p className="pt-disclaimer-text">
            Processing times reflect 80% of applications and change frequently
            based on application volumes, staffing, and IRCC policy. Always
            verify current times on{' '}
            <a href={url} target="_blank" rel="noopener noreferrer">
              canada.ca
            </a>{' '}
            before making decisions. Times shown are for complete applications
            only — incomplete packages significantly extend timelines.
          </p>
        </div>
      </section>
            ...
            <div className="pt-cards-grid">
              {programs
                ...
                .map((p) => (
                  <div
                    key={p.id}
                    className={`pt-card ${urgencyClass(p.months)}`}
                  >
      ...
      <section className="pt-factors-section">
        <div className="pt-factors-inner">
          ...
          <h2 className="pt-factors-heading">
          ...
          <div className="pt-factors-grid">
            <div className="pt-factor">
              ...
              <p>
                A missing police certificate or incorrect ECA can pause your
                file for months. Visa Forte reviews every document before
                submission.
              </p>
            </div>
            <div className="pt-factor">
              <h3>Biometrics</h3>
              <p>
                IRCC will not begin processing until biometrics are collected.
                Book your appointment the day you receive your instruction
                letter.
              </p>
            </div>
            <div className="pt-factor">
              ...
              <p>
                Medical exams are valid for 12 months. If your exam expires
                during processing, IRCC will require a new one — adding weeks or
                months.
              </p>
            </div>
            <div className="pt-factor">
              ...
              <p>
                IRCC processing times fluctuate with the number of applications
                received. High-volume invitation rounds (1,000+) can lengthen
                queues across all streams.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pt-cta-section">
        <div className="pt-cta-inner">
          ...
          <p className="pt-cta-sub">
            Visa Forte prepares complete, IRCC-ready documentation packages — so
            your file moves through the queue without delays.
          </p>
          <div className="pt-cta-actions">
            <a href="/intake" className="btn-primary">
              Start your profile
            </a>
            <a href="/assessment" className="link-ghost">
